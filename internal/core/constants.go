...
// OpenConnectConnectionStatus represents the current state of the OpenConnect connection
type OpenConnectConnectionStatus string

const (
	OpenConnectStatusDisconnected OpenConnectConnectionStatus = "disconnected"
	OpenConnectStatusConnecting   OpenConnectConnectionStatus = "connecting"
	OpenConnectStatusConnected    OpenConnectConnectionStatus = "connected"
	OpenConnectStatusError        OpenConnectConnectionStatus = "error"
)
